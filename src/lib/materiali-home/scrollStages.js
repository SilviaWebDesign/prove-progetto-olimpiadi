/** Rotazione 2π completata — da qui la camera entra nella neve */
export const HOME_ORBIT_END = 0.46;
/** Inizio immersione neve + fade verso bianco (allineato alla fine orbita) */
