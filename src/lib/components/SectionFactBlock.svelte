<script lang="ts">
  ...
  let { title, body, source, counter, class: className = '' }: Props = $props();
</script>
...
<div class="section-fact-block {className}">
  ...
  <p class="section-fact-block__source">– {source}</p>
</div>
