<script>
  ...
  import SectionMountainScene from '$lib/components/file-chiara/SectionMountainScene.svelte';
  import OrbitCardsLayer from '$lib/components/file-chiara/OrbitCardsLayer.svelte';
  import FactMainStage from '$lib/components/file-chiara/FactMainStage.svelte';
  import CardModel from '$lib/components/file-chiara/CardModel.svelte';
  import { sections } from '$lib/components/file-chiara/sections.js';
  import { stageOpacity, clamp, remap } from '$lib/components/file-chiara/scrollStages.js';
  import {
    getFactDockT,
...
<div class="journey" bind:this={container}>
  ...
  >
    <div
      class="hero-image"
      style="background-image: url('{section.hero.background}')"
      role="img"
      aria-label="Foresta"
    ></div>
    <div class="hero-overlay" aria-hidden="true"></div>
    <h1 class="hero-title">{section.heroTitle}</h1>
  </section>
...
<style>
  ...
  .hero-title {
    ...
    font-size: min(260px, max(18vw, 12vw));
    font-weight: 900;
  ...
  @media (max-width: 900px) {
    .hero-title {
      font-size: min(10rem, max(15vw, 4rem));
      white-space: normal;
    }
