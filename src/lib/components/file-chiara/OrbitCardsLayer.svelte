<script>
  import SustainabilityOrbitScene from '$lib/components/file-chiara/SustainabilityOrbitScene.svelte';
  import { getFactDockT, DOCK_UI_THRESHOLD } from '$lib/components/file-chiara/sustainabilityDock.js';
